#!/usr/bin/env python3
"""Convert docs/navigation_run.md -> docs/navigation_run.html as a single-file
...
SRC = HERE / "navigation_run.md"
DST = HERE / "navigation_run.html"
...
<title>Isaac Sim ナビゲーション 実行手順 — TRON-KK</title>
<meta name="generator" content="docs/build_navigation_run_html.py">
<style>{CSS}</style>
{MERMAID_SCRIPT}
</head>
<body>
...
<header class="cover">
  <div class="inner">
    ...
    <h1>Isaac Sim ナビゲーション 実行手順<br>環境構築済みからの起動ガイド</h1>
    <div class="meta">G1 humanoid（Isaac Sim 5.0 + ROS 2 Humble + Nav2） &nbsp;·&nbsp; 第 1.0 版 &nbsp;·&nbsp; 2026-06-25</div>
  </div>
</header>
